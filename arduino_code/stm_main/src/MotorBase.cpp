...
MotorBase::MotorBase(int x, unsigned int T) 
    : enc(quadTimer[x], TICK_RATIO, T), pwm(pwmPin[x], pwmTimer[x]) {
}
...
unsigned long MotorBase::getCurrTime(){
